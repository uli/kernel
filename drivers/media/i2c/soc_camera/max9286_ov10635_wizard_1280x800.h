...
{0x4620, 0x0E},
#if 0
{0x4700, 0x02}, /* BT656: mode is acceptable but artefact lines on left/bottom
		*  due to BT656 SAV/EAV are parsed as image data
		*/
#else
...
{0x4702, 0x01},
#ifdef YUV_10BIT
{ 0x4302, 0x03 }, { 0x4303, 0xfe }, { 0x4304, 0x00 },
{ 0x4305, 0x02 }, { 0x4306, 0x03 }, { 0x4307, 0xfe }, 
{ 0x4308, 0x00 }, { 0x4309, 0x02 },
#endif
{0x4004, 0x04},
{0x4005, 0x18},
{0x4001, 0x06},
